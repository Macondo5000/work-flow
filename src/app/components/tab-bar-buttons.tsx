...
import svgPaths from "../../imports/svg-l5pgks3whr";

function Blur1() {
  return <div className="h-[62px] rounded-full shrink-0 w-[294px]" data-name="Blur" />;
}

function Mask() {
  return (
    <div className="absolute bg-transparent inset-[-50px]" data-name="Mask">
      <div className="absolute bg-transparent inset-[76px] rounded-full" data-name="Shape" />
    </div>
  );
}
...
function Fill() {
  return (
    <div className="absolute inset-0 rounded-full overflow-hidden" data-name="Fill">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-full backdrop-blur-2xl backdrop-saturate-150">
...
function Status() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-center justify-center mr-[-10px] pb-[7px] pt-[6px] px-[8px] relative shrink-0 w-[102px]" data-name="Status">
      <div className="absolute bg-[#f3f4f6] inset-0 rounded-full" data-name="Selection" />
      <Icon />
    </div>
  );
}
...
function Status1() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-center justify-center mr-[-10px] pb-[7px] pt-[6px] px-[8px] relative shrink-0 w-[102px]" data-name="Status">
      <div className="absolute inset-0 rounded-full" data-name="Selection" />
      <Icon1 />
    </div>
  );
}
...
function GlassEffect() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0)] inset-0 rounded-full" data-name="Glass Effect">
      <Frame />
    </div>
  );
}
...
export function TabBarButtons() {
  return (
    <div className="content-stretch flex items-start justify-center relative shadow-[0px_4px_24px_0px_rgba(0,0,0,0.1)] rounded-full" data-name="Tab Bar Buttons">
      <Bg />
    </div>
  );
}
